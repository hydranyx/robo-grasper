...
\begin{abstract}
  ...
  % \item Extracting HOG (Histogram of Oriented Gradients) features.
  % \item Extracting SIFT (Scale-Invariant Feature Transform) features.
  % \end{itemize}
...
%%% TODO move angles to another section
...
\section{Method}
% \noindent {\bf [4 points]}
% This section should describe the overall approach used in the work. The description can be subdivided in subsections to enhance readability. We added four subsections but you are free to add more.
...
% Describe how you developed the part 1 of method. Do not write in terms of how you used the software tools, but write in terms of how  you developed the part 1 of the method.
