...
class alicecontrollerfunctionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new alicecontrollerfunctionFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new alicecontrollerfunctionFeedback(null);
...
module.exports = alicecontrollerfunctionFeedback;
