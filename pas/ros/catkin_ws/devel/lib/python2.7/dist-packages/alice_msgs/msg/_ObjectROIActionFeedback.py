...
"""autogenerated by genpy from alice_msgs/ObjectROIActionFeedback.msg. Do not edit."""
import sys
...
class ObjectROIActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "alice_msgs/ObjectROIActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','alice_msgs/ObjectROIFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectROIActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = alice_msgs.msg.ObjectROIFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = alice_msgs.msg.ObjectROIFeedback()
