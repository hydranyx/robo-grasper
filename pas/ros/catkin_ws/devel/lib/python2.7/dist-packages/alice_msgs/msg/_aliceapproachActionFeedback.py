...
"""autogenerated by genpy from alice_msgs/aliceapproachActionFeedback.msg. Do not edit."""
import sys
...
class aliceapproachActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "alice_msgs/aliceapproachActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','alice_msgs/aliceapproachFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(aliceapproachActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = alice_msgs.msg.aliceapproachFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = alice_msgs.msg.aliceapproachFeedback()
